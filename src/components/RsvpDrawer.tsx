...
const RsvpDrawer = ({ show, onClose, onSubmit, isAttending, hasRsvped, rsvpName }: RsvpDrawerProps) => {
  ...
  return (
    <>
      ...
      />
      <div 
        className="fixed inset-0 z-50 overflow-hidden flex items-start sm:items-center justify-center"
      >
        <div className="relative w-full sm:w-[28rem] max-h-[100dvh] flex flex-col">
          <div className="w-full min-h-screen sm:min-h-0 sm:rounded-2xl bg-neutral-900 overflow-y-auto overscroll-contain">
